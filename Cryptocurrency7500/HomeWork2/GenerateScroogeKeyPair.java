...
public class GenerateScroogeKeyPair {
    ...
    public String storeSecretKeyToEncrypted(PrivateKey sk, String filename, String password) throws IOException {
...
//PEMWriter writer = new PEMWriter(new FileWriter(filename));
    ...
    public static void main(String[] args) throws Exception {
        new GenerateScroogeKeyPair().run("Scrooge", "testScrooge");
    }
}
